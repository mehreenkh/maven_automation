...
public class Reusable_Actions_Loggers {
    ...
    public static void clickAction1(WebDriver driver, String xpath, ExtentTest loggers, String elementName){
        WebDriverWait wait = new WebDriverWait(driver,timeout);
        try{
            WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath)));
            element.click();
            loggers.log(LogStatus.PASS,"Successfully submit on element " + elementName);
        } catch (Exception e) {
    ...
    public static String verifyTitle(WebDriver driver,String xpath,ExtentTest logger, String elementName){
        WebDriverWait wait = new WebDriverWait(driver,10);
        String verifyTitle = driver.getTitle();
        if (verifyTitle.contains(elementName)){
            ...
            logger.log(LogStatus.FAIL,"Unable to find title " + elementName + " " + elementName);
